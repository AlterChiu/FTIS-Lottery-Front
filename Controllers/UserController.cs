...
namespace DouImp.Controllers
{
    ...
    public class UserController : Dou.Controllers.UserBaseControll<User, Role>
    {
        ...
        internal static FtisHelperDrawGame.DB.Model.F22cmmEmpData CurrentFtisEmployee
        {
            get { return DouUnobtrusiveSession.Session["CurrentFtisUser"] as FtisHelperDrawGame.DB.Model.F22cmmEmpData; }
        }
